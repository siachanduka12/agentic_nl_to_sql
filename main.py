...
def retrieve_context(question):
    ...
    print("\nSchema Distance:")
    print(schema_results["distances"])

    print("\nExcel Distance:")
    print(excel_results["distances"])

    if pdf_results:
        print("\nPDF Distance:")
        print(pdf_results["distances"])
    ...
    if pdf_results and pdf_results["documents"][0]:
        ...
        try:
            used_sources.append(
                pdf_results["metadatas"][0][i]["filename"]
            )
        except:
...
def process_query(question):
    ...
    print("\n===== PDF CHECK =====")
    print("PDF CONTEXT" in retrieved_context)
    print("EXCEL CONTEXT" in retrieved_context) 
    ...
    5. You MUST use table names exactly as shown in LIVE DATABASE SCHEMA.
    6. You MUST use column names exactly as shown in LIVE DATABASE SCHEMA.
